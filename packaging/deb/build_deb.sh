...
DIST_DIR="${GRIDLENS_BUNDLE_DIR:-${ROOT_DIR}/dist/GridLens}"
...
mkdir -p "${PACKAGE_ROOT}/usr/share/doc/gridlens/agent-sandbox"
...
cp "${ROOT_DIR}/packaging/agent/Dockerfile" "${PACKAGE_ROOT}/usr/share/doc/gridlens/agent-sandbox/Dockerfile"
cp "${ROOT_DIR}/packaging/agent/README.md" "${PACKAGE_ROOT}/usr/share/doc/gridlens/agent-sandbox/README.md"
...
chmod 0644 "${PACKAGE_ROOT}/usr/share/doc/gridlens/agent-sandbox/Dockerfile"
chmod 0644 "${PACKAGE_ROOT}/usr/share/doc/gridlens/agent-sandbox/README.md"
chmod 0644 "${PACKAGE_ROOT}/usr/share/icons/hicolor/scalable/apps/gridlens.svg"

mkdir -p "${OUTPUT_DIR}"
dpkg-deb --root-owner-group --build "${PACKAGE_ROOT}" "${OUTPUT_DIR}/gridlens_${VERSION}_${ARCH}.deb"
echo "Created ${OUTPUT_DIR}/gridlens_${VERSION}_${ARCH}.deb"
